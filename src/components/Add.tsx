...
export const Add = () => {
  ...
  const addOrder = () => {
    const newOrder = {
      id: generateId(),
      customer_name: currOrder.customer_name,
      customer_email: currOrder.customer_email,
      product: currOrder.product,
      quantity: currOrder.quantity,
    };
    const newOrderSet = [newOrder, ...orders];
    setOrders(newOrderSet);
    window.localStorage.setItem(
      getUserDetail().email,
      JSON.stringify(newOrderSet)
    );
